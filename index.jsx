    ...
    members: {
        ...
        associates: [
            ...
            { 
                ...
                bio: "Bióloga (UdeA) con experiencia en conservación de tortugas, ecoacústica y parasitología de anfibios.", 
                education: "Bióloga, Universidad de Antioquia (2024)",
                areas: ["Turtle Conservation", "Ecoacoustics", "Bioacoustics", "Parasitology", "Wildlife Management"],
                profile_desc: "Johana Pérez Mira es una bióloga egresada de la Universidad de Antioquia y radicada en Medellín , cuyo perfil profesional integra una sólida trayectoria en herpetología y vida silvestre. Su experiencia en investigación es amplia y diversa: además de su trabajo documentado sobre los parámetros de determinación sexual en la tortuga sabanera (Podocnemis vogli), su labor científica abarca la ecoacústica, la bioacústica y el estudio de parásitos en ranas. En el ámbito de la conservación, se ha desempeñado como Líder Asistente de Investigación voluntaria en la organización COPROT Tortugas de Osa y cuenta con formación especializada en el monitoreo de tortugas marinas. Esta experiencia de campo se complementa con su paso por el laboratorio de genética animal como joven investigadora entre 2021 y 2022. Actualmente, ejerce como herpetóloga independiente, consolidando un perfil que une la conservación de tortugas y los estudios acústicos y parasitológicos en anfibios.",
                publications: [
        ...
        undergrad: [
            ...
            { name: "Katerine Rodríguez", bio: "Joven investigadora. Actualmente trabaja con caracteres morfológicos en serpientes." }
        ]
    },
    research_lines: [
        { 
